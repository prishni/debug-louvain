...
function batch_run_diggs_full_rntf()
...
R_types = {'FullP','FullD','FullC'};

filename=sprintf('%sblog_%s_v%d-%d_%s%d%s%d',outfilepath,'run_diggs_full_rntf',data_ver,res_ver,stream_s,TMIN,stream_s,TMAX);

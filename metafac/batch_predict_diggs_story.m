...
batch_run_diggs_rntf
batch_foldin_diggs_story
...
filename=sprintf('%sblog_%s_v%d-%d_%s%d%s%d',outfilepath,'predict_diggs_story',data_ver,res_ver,stream_s,TMIN,stream_s,TMAX);

function [S,U,iters,cvtime,ll] = rntf(RG,Vdims,rank,prior)
% RNTF (METAFAC) - relatoinal non-negative tensor decomposition
...
[S,U,iters,cvtime,ll] = rntf_imp(RG,Vdims,rank,prior);
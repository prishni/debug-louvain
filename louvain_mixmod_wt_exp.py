...
modfile = open(pathtosave+"modComparisionMixModLouvain_wt_correctedImplementation_exp2",'w')
...
for network in networklist:
    ...
    modfile = open(pathtosave+"modComparisionMixModLouvain_wt_correctedImplementation_exp2",'a')

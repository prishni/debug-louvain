...
with open(str2+'_commu_benching_all_louvain_mixmod.pickle', 'wb') as handle:
    pickle.dump(partition_at_level(commus, len(commus)-1), handle)
with open(str2+'_modu_benching_all_louvain_mixmod.pickle', 'wb') as handle:
    pickle.dump(modu, handle)
with open(str2+'_commu_benching_frac_louvain_mixmod.pickle', 'wb') as handle:
